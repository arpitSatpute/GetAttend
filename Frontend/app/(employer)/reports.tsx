...
// Reuse the same mock employee data
const mockEmployees = [
  {
    id: 'emp1',
    name: 'Alice Johnson',
  ...
  if (selected) {
    ...
    return (
      <View style={styles.detailContainer}>
        ...
        <Text style={styles.label}>Current Status: <Text style={styles.value}>{emp.status}</Text></Text>
        <Text style={styles.label}>Location: <Text style={styles.value}>{emp.location}</Text></Text>
